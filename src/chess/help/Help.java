...
public class Help {
	...
	static {
		...
		helpHashMap.put(PieceType.BISHOP, "Bishops can move to any tile in any diagonal direction, as long as nothing is blocking their way.");
		helpHashMap.put(PieceType.KING, "The king can move one space in any direction, as long as it does not put them in check.");
		helpHashMap.put(PieceType.KNIGHT, "Knights move in a Knights pattern, which is:\n"
		...
		helpHashMap.put(PieceType.PAWN, "Pawns can move one tile forward, except:\n"
	...
	public static String gamerules () {
		//TODO actual rules
		return "Chess is a two-player board game played on a chessboard, a checkered game board with 64 squares \n"
